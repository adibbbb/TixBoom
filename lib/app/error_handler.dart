...
class ErrorHandler implements Exception {
  ...
  ErrorHandler.handle(
    dynamic error, {
    List<String> messageKeys = const ['MESSAGE', 'msg', 'message'],
...
Failure _handleErrorDio(
    DioException error, List<String> messageKeys, bool preferNestedMessage) {
  switch (error.type) {
    case DioExceptionType.badResponse:
      final statusCode = error.response?.statusCode ?? 0;
      final responseData = error.response?.data;
      final message = _extractErrorMessageFlexible(
          responseData, messageKeys, preferNestedMessage);
